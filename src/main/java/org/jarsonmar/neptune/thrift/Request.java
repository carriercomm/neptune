...
public class Request implements org.apache.thrift.TBase<Request, Request._Fields>, java.io.Serializable, Cloneable {
   ...
   * @see RequestType
   */
  public RequestType rtype; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RTYPE, new org.apache.thrift.meta_data.FieldMetaData("rtype", org.apache.thrift.TFieldRequirementType.DEFAULT, 
   ...
   * @see RequestType
   */
  public Request setRtype(RequestType rtype) {
    this.rtype = rtype;
    return this;
  }
  ...
  public int compareTo(Request other) {
    ...
    lastComparison = Boolean.valueOf(isSetRtype()).compareTo(typedOther.isSetRtype());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRtype()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.rtype, typedOther.rtype);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class RequestStandardScheme extends StandardScheme<Request> {
        ...
        switch (schemeField.id) {
          case 1: // RTYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.rtype = RequestType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Request struct) throws org.apache.thrift.TException {
      ...
      if (struct.rtype != null) {
        ...
        oprot.writeI32(struct.rtype.getValue());
        oprot.writeFieldEnd();
      }
